...
class UnmaskingStrategy(enum.Enum):
    ...
    def from_str(cls, strategy: str):
        ...
        elif strategy == 'bounded_adaptive_confidence_decoding':
            return cls.BACD
        else:
...
class DLLMConfig:
    ...
    confidence_lower_threshold: float = 0.6
    confidence_upper_threshold: float = 0.9
...
class MiscConfig:
    ...
    def from_engine_config(cls, engine_config: PytorchEngineConfig):
        ...
        dllm_config = DLLMConfig(block_length=engine_config.dllm_block_length,
                                 ...
                                 confidence_lower_threshold=engine_config.dllm_confidence_lower_threshold,
                                 confidence_upper_threshold=engine_config.dllm_confidence_upper_threshold)
